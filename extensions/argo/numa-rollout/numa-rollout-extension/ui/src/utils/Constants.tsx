...
export const MONOVERTEX_ROLLOUT = "MonoVertexRollout";
export const ISB_KUBERNETES = "isbsvc";
export const CONTROLLER_MANAGER = "controller-manager";
export const VERTEX = "vertex";
export const MONO_VERTEX = "mono-vertex";
export const KUBERNETES_APP = "app.kubernetes.io/component";
export const ISB = "InterStepBufferService";
