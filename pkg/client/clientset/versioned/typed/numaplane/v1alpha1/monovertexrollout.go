...
func (c *monoVertexRollouts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MonoVertexRollout, err error) {
	result = &v1alpha1.MonoVertexRollout{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *monoVertexRollouts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MonoVertexRolloutList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MonoVertexRolloutList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("monovertexrollouts").
...
func (c *monoVertexRollouts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *monoVertexRollouts) Create(ctx context.Context, monoVertexRollout *v1alpha1.MonoVertexRollout, opts v1.CreateOptions) (result *v1alpha1.MonoVertexRollout, err error) {
	result = &v1alpha1.MonoVertexRollout{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("monovertexrollouts").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(monoVertexRollout).
		Do(ctx).
		Into(result)
	return
}
...
func (c *monoVertexRollouts) Update(ctx context.Context, monoVertexRollout *v1alpha1.MonoVertexRollout, opts v1.UpdateOptions) (result *v1alpha1.MonoVertexRollout, err error) {
	result = &v1alpha1.MonoVertexRollout{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monovertexrollouts").
...
func (c *monoVertexRollouts) UpdateStatus(ctx context.Context, monoVertexRollout *v1alpha1.MonoVertexRollout, opts v1.UpdateOptions) (result *v1alpha1.MonoVertexRollout, err error) {
	result = &v1alpha1.MonoVertexRollout{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monovertexrollouts").
...
func (c *monoVertexRollouts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *monoVertexRollouts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *monoVertexRollouts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MonoVertexRollout, err error) {
	result = &v1alpha1.MonoVertexRollout{}
