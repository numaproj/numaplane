...
func (in *UpgradingChildStatus) DeepCopyInto(out *UpgradingChildStatus) {
	*out = *in
	if in.AssessmentStartTime != nil {
		in, out := &in.AssessmentStartTime, &out.AssessmentStartTime
		*out = (*in).DeepCopy()
	}
	if in.AssessmentEndTime != nil {
		in, out := &in.AssessmentEndTime, &out.AssessmentEndTime
		*out = (*in).DeepCopy()
	}
