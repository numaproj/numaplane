...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PipelineTypeFailureStatus) DeepCopyInto(out *PipelineTypeFailureStatus) {
	*out = *in
	in.FailureStatus.DeepCopyInto(&out.FailureStatus)
	in.Analysis.DeepCopyInto(&out.Analysis)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PipelineTypeFailureStatus.
func (in *PipelineTypeFailureStatus) DeepCopy() *PipelineTypeFailureStatus {
	if in == nil {
		return nil
	}
	out := new(PipelineTypeFailureStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *UpgradingISBServiceStatus) DeepCopyInto(out *UpgradingISBServiceStatus) {
	*out = *in
	...
	if in.FailureHistory != nil {
		in, out := &in.FailureHistory, &out.FailureHistory
...
func (in *UpgradingPipelineTypeStatus) DeepCopyInto(out *UpgradingPipelineTypeStatus) {
	*out = *in
	...
	if in.FailureHistory != nil {
		in, out := &in.FailureHistory, &out.FailureHistory
		*out = make([]PipelineTypeFailureStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
