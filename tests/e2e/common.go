...
const (
	...
	PrimaryNumaflowControllerVersion = "1.7.3"
	...
	UpdatedNumaflowControllerVersion = "1.7.3"
...
func getPromotedChildResource(gvr schema.GroupVersionResource, namespace, rolloutName string) (*unstructured.Unstructured, error) {
