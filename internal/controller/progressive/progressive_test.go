...
func (fpc fakeProgressiveController) CheckForDifferences(ctx context.Context, rolloutObject ctlrcommon.RolloutObject, childDef *unstructured.Unstructured, requiredSpec map[string]interface{}, requiredMetadata map[string]interface{}, existingIsUpgrading bool) (bool, error) {
	return false, nil
}

func (fpc fakeProgressiveController) CheckForDifferencesWithRolloutDef(ctx context.Context, existingChild *unstructured.Unstructured, rolloutObject ctlrcommon.RolloutObject, ignoreProgressiveModifiedFields bool) (bool, error) {
	return false, nil
}
